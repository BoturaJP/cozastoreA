...
[Table("Produto")]
    public class Produto
    {
        ...
        [Column(TypeName = "decimal(8,2)")]
        [Required(ErrorMessage = "Informe o preço de desconto")]
        ...
        [StringLength(30, ErrorMessage = "O Material deve possuir o m máximo 30 caractereres")]
        public string Material { get; set; }

        [Display(Name = "Dimensões")]
        [StringLength(30, ErrorMessage = " As Dimensões deve possuir ao máxmo 30 caracteres")]
